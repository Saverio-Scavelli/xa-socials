...
import com.xaver.service.EmailService;
import com.xaver.service.UserService;
...
public class AuthController {
	...
	private String invaliUserMessage;
	...
	ModelAndView restrationConfirmed(ModelAndView modelAndView){
	...
	ModelAndView invalidUser(ModelAndView modelAndView){
		modelAndView.getModel().put("message", invaliUserMessage);
		modelAndView.setViewName("app.message");
...
//		if(true)
//			throw new FileNotFoundException("This is a dreadfull exception.");
